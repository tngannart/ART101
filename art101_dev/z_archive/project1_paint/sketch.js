...
case '6':
 ...
 break;
 case '7':
    console.log("7");  // make your first brush here!!_turbo brush

sdTurboBrush(random(10,100), mouseX, mouseY, pmouseX, pmouseY);    
...
function drawline( k,  lx, ly,  px, py) {
  ...
  stroke(k);
  line(lx, ly, px, py);
  line(lx-10,ly+10,px,py);
  line(lx+20,ly+10,px+10,py);
  blendMode(MUTIPLY)
  console.log(mouseX);
  console.log(pmouseX);
}
...
function sdTurboBrush(kcount, lx, ly,  px, py) {

  //strokeWeight(random(1,35));
  strokeWeight(kcount);
  stroke(0,kcount*3,20,20);
  fill(150,0,0);
  //image(b,lx,ly, 30,30);
  line(lx, ly, px, py);
  rect(lx, ly, kcount,kcount,10)
}
