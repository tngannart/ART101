...
function Crab() {
    ...
    this.draw = function() {
        ...
        // Vẽ nút Help
        let btnevent1 = checkButtonPress("Help", this.btHelp.x, this.btHelp.y, this.btHelp.w, this.btHelp.h, color(220, 100, 100), color(100), color(250));
        if (btnevent1) {
            this.sceneManager.showScene(help);  // Chuyển sang Help scene
        }
    }
...
function help() {
    this.setup = function() {
        ...
        // Setup bất kỳ thứ gì cần thiết cho help scene
    }

    this.enter = function() {
        console.log("We are at entering for help");
        // Set visible các đối tượng (nếu cần)
        ghosty.visible = false;  // Ví dụ như ẩn ghosty
    }
